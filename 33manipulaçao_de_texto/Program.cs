// Declarando uma string e uma variável numérica
string nome = "Fernando";
int idade = 26;

// Concatenação básica
string sobrenome = "Claro";
string nomeCompleto = nome + " dos Santos " + sobrenome;

// Concanetação por interpolação de strings
string mensagem = $"Olá, meu nome é {nomeCompleto} e tenho {idade} anos de idade.";
string mensagem2 = $"Olá, {nome} {sobrenome}!";
